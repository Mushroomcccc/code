...
from src.core.envs.Simulated_Env.dna4ir_env import DNaIRSimulatedEnv
...
def get_args_DNaIR():
    ...
    parser.add_argument("--model_name", type=str, default="DNA4IR")
...
def prepare_train_envs_local(args, ensemble_models, env, dataset, kwargs_um):
    ...
    env_data = "KuaiRand_Pure" if args.env == "KuaiRand-v0" else "MovieLens"
