...
class HReplayBuffer(ReplayBuffer):
    ...
    _reserved_keys = (
        ...
        "policy", "is_start", "rew_prev", "env_step", "h_rew", "h_act"
    )
    _input_keys = (
        "obs", "act", "rew", "terminated", "truncated", "obs_next", "info",
        "policy", "is_start", "rew_prev", "env_step", "h_rew", "h_act"
    )
    ...
    def __getitem__(self, index: Union[slice, int, List[int], np.ndarray]) -> Batch:
        ...
        batch_dict = {
            ...
            "env_step": self.get(indices, "env_step", Batch()),
            "h_rew": self.get(indices, "h_rew", Batch()),
            "h_act": self.get(indices, "h_act", Batch()),
        }
