...
from src.core.userModel.user_model_pairwise_variance import UserModel_Pairwise_Variance
...
class EnsembleModel():
    def __init__(self, num_models, message, MODEL_SAVE_PATH, *args, **kwargs):
        ...
        self.AB_PATH = os.path.join(MODEL_SAVE_PATH, "ab", f"[{message}]_ab.pickle")
    ...
    def save_all_models(self, dataset_val, x_columns, y_columns, ab_columns, df_user, df_item, df_user_val, df_item_val,
        ...
        with open(self.AB_PATH, "wb") as f:
            pickle.dump(ab_columns, f)
